          ...
          groups: [
            {
              ...
              // NUMBERED, matching the numbered list the model writes
              // in its text. The person answers "the second one", and
              // that only refers to something if both surfaces count
              // the same way — an unnumbered card beside a numbered
              // list is worse than either alone.

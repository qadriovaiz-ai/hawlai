...
export default function DealershipSwitcher() {
  ...
  // Only shown for pure agency staff on 2+ teams with no business of
  // their own — see /api/agency/switch for why owners aren't offered
  // this yet.
  if (loading || !data || data.ownsABusiness || (data.dealerships?.length ?? 0) < 2) return null;

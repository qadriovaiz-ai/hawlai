...
export function GeneratedOutputPanel({
  ...
  return (
    <Card className="space-y-2">
      ...
      {/* Written from nothing of this business's own story (lib/content/storyEcho.ts) — said, not shipped quietly. */}
      {typeof output?._storyNote === "string" && <p className="text-xs text-amber-500">{output._storyNote}</p>}

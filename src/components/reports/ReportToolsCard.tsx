      ...
      <div className="pt-3 border-t border-slate-200 space-y-2">
        ...
        {loading ? (
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 text-xs bg-slate-200 rounded-lg px-3 py-2 text-slate-600 truncate">/report/{token}</code>
      ...
      {snapshots.length > 0 && (
        <div className="pt-3 border-t border-slate-200 space-y-1.5">
          ...
          <div className="space-y-1.5 max-h-56 overflow-y-auto">
            {snapshots.map((s) => (
              <div key={s.id} className="bg-slate-200 rounded-lg p-2.5 flex items-center justify-between">

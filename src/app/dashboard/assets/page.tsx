        ...
        <>
          ...
          {logos.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
                {logos.map((l) => (
                  <a key={l.name} href={l.url} target="_blank" rel="noopener noreferrer" className="aspect-square rounded-lg overflow-hidden border border-slate-300 bg-slate-200 flex items-center justify-center p-2">

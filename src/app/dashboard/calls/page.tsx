...
export default async function CallsPage() {
  ...
  return (
    <div className="max-w-6xl space-y-5">
      ...
      <div className="card p-4 bg-gradient-to-r from-purple-50 to-brand-50 border-purple-100">
        <p className="text-sm font-semibold text-purple-800 mb-1">🔌 Vapi AI Calling Integration Ready</p>

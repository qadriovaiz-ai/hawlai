            ...
            <div className="grid gap-2">
              {EXAMPLES.map((ex, i) => (
                <button
                  ...
                  className="text-left text-sm text-slate-600 bg-slate-100 border border-slate-200 rounded-lg px-4 py-2.5 hover:border-brand-300 hover:bg-brand-500/10 transition-colors"
                >
                  "{ex}"
                </button>
              ))}
